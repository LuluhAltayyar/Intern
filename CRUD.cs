...
public class CRUD
{
    ...
    public static string  conStr = WebConfigurationManager.ConnectionStrings["University2ConnectionString"].ConnectionString;
    SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["University2ConnectionString"].ConnectionString);
